...
/// next : null
/// previous : null
/// results : [{"id":1,"student":{"id":1,"user":"Fatima","first_name":"fatima","last_name":"nasser","department":"mathematics"},"lecture":1,"attend":1,"total_attendance":2,"attendance_percentage":40.0,"absent_percentage":0.0,"lecture_week":1},{"id":2,"student":{"id":2,"user":"Ganna","first_name":"Ganna","last_name":"Mahmoud","department":"mathematics"},"lecture":1,"attend":1,"total_attendance":1,"attendance_percentage":20.0,"absent_percentage":0.0,"lecture_week":1},{"id":3,"student":{"id":1,"user":"Fatima","first_name":"fatima","last_name":"nasser","department":"mathematics"},"lecture":2,"attend":1,"total_attendance":2,"attendance_percentage":40.0,"absent_percentage":0.0,"lecture_week":2}]
...
class Attandence {
  ...
  Attandence.fromJson(dynamic json) {
    count = json['count'];
    next = json['next'];
